...
from dice.generate_hex import produce_sites_and_site_areas
from dice.system_simulator import SimulationManager
...
if __name__ == '__main__':
    ...
    INCREMENT_MA = (50, 40000, 50) #(400, 40400, 1000) #1000,125)#
